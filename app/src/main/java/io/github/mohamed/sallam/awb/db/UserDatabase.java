...
import io.github.mohamed.sallam.awb.db.entity.DetoxSchedule;
import io.github.mohamed.sallam.awb.db.entity.DetoxSettings;
 ...
 */
@Database(entities = {BlockedApp.class, DetoxPeriod.class, DetoxSchedule.class,
        DetoxSettings.class, Device.class, Group.class},
